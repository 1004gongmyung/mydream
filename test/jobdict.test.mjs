...
test("검색 인식: 요청된 세부 직업들이 전부 잡힌다 (별칭·문장 포함)", () => {
  ...
  for (const q of ["간호조무사", "직업군인", "직업경찰", "환경미화원", "요리사", "선교사", "군인이 되고 싶어요", "셰프", "파일럿", "변호사", "외교관", "큐레이터", "작곡가", "굴착기기사", "공인중개사", "택배기사", "철학자", "사학자", "심리학자", "한약사", "행정사", "연예인", "사진사", "어린이집교사", "특수학교교사", "상담사", "순경", "영화감독", "연출가", "미술감독", "스포츠감독", "지휘자", "성악가", "의상디자이너", "피부미용", "치과의사", "안경사", "공학자", "물리학자", "재료공학", "우주공학", "민속학", "종교연구가", "정치인", "프로파일러", "사육사", "실용음악과", "회화과", "약학과", "전자공학과", "식품영양과", "아이돌", "웹소설작가", "스포츠지도사", "열차기장", "도슨트"]) {

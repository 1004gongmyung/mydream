...
- **실데이터 수록(2026-07-27, 종단 공식 사이트 검증)**: 9개 경로 — 목사(예장통합·예장합동·감리회 3개 교단, 교단별 인준 신학교 매칭), 신부(천주교), **수녀·수사(천주교 수도회 — 종신서원 전까지 전부 가역)**, 스님(조계종 — 미성년 진입 가능·출가상담 1666-7987), 교무(원불교), 사제(성공회), 이맘(이슬람 — 국내 양성기관 없음 사실 카드) + 양성기관 12곳(인준·학위 2축 명시). 빌드 가드 통과로 자동 노출. 수록 현황·절차·원칙: `docs/clergy-module.md`

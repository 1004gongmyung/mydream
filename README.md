...
- **실데이터 수록(2026-07-27, 종단 공식 사이트 검증)**: 6개 경로 — 목사(예장통합), 신부(천주교), 스님(조계종 — 미성년 진입 가능·출가상담 1666-7987), 교무(원불교), 사제(성공회), 이맘(이슬람 — 국내 양성기관 없음 사실 카드) + 양성기관 8곳(인준·학위 2축 명시). 빌드 가드 통과로 자동 노출. 수록 현황·절차·원칙: `docs/clergy-module.md`
